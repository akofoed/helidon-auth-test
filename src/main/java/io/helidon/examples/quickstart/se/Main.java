...
public final class Main {
    ...
    private static Routing createRouting(Config config) {
        ...
        JwtProvider jwtProvider = JwtProvider.builder()
            .optional(true)
            .verifyJwk(Resource.create("helidon-jwk.json"))
            .build();
        

        Map<String, MyUser> users = new HashMap<>();
        MyUser userAkofoed = new MyUser(1, "akofoed", new char[]{'p','a','s','s','w','o','r','d'}, Arrays.asList("users"));
        users.put("akofoed", userAkofoed);
        MyUser userJohn = new MyUser(2, "john", new char[]{'p','a','s','s','w','o','r','d'}, Arrays.asList("users"));
        users.put("john", userJohn);
        UserStore userStore = user -> Optional.ofNullable(users.get(user));
        ...
        Security security = Security.builder()
            .addProvider(httpBasicAuthProvider, "userauth")
            .addProvider(jwtProvider, "jwt")
            .build();
